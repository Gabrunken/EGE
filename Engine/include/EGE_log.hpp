...
namespace EGE
{
	...
	private:
		...
		static std::queue<std::string> ErrorMessages;
		static std::queue<std::string> WarningMessages;
		static std::queue<std::string> NoteMessages;
		static std::queue<std::string> SuccessMessages;
